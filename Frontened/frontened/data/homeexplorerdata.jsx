const homeexplorerdata = [
    ...
    },
    {
      ...
      courses: [
        ...
        {
          heading: "CSS",
          description: "This course explores advanced topics in HTML5 and CSS3, including animations, transitions, and Tayout techniques",
          level: 'Beginner',
          lessionNumber: 6
        },
        {
          heading: "Responsive",
          description: "This course teaches responsive web design techniques, allowing web pages to adant to different devices and screen sizes",
          level: 'Beginner',
          lessionNumber: 10
        }
      ]
  ...
  export default homeexplorerdata;