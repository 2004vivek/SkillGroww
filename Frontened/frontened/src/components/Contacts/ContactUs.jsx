        ...
        <form action="" onSubmit={handleSubmit(submitContactForm)}>
            <div className='flex gap-4 flex-col md:flex-row'>
                <div className='flex flex-col'>
                    <label htmlFor="" className='text-white text-[14px] md:text-[14px] xl:text-[16px]'>First Name:</label>
                    <input type="text" 
                    name="firstname"
                ...
                <div className='flex flex-col'>
                    <label htmlFor="" className='text-white text-[14px] md:text-[14px] xl:text-[16px]'>Last Name:</label>
            ...
            <div className='flex flex-col mt-4'>
                <label htmlFor="" className='text-white text-[14px] md:text-[14px] xl:text-[16px]'>Email Address:</label>
            ...
            <div className='flex flex-col mt-4'>
                <label htmlFor="" className='text-white text-[14px] md:text-[14px] xl:text-[16px]'>Phone Number:</label>
            ...
            <div className='flex flex-col  mt-4'>
                <label htmlFor="" className='text-white text-[14px] md:text-[14px] xl:text-[16px]'>Message:</label>
            ...
            <div><button type='submit' className='bg-yellow-400 mt-4 p-2 rounded-md cursor-pointer font-bold text-[14px] md:text-[14px] xl:text-[16px]' >Send Message</button></div>
